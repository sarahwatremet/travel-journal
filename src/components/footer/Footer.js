    ...
    return (
        <div className="footer">
            <a href="https://github.com/sarahwatremet" target="_blank" rel="noreferrer" alt="link to github">
                <img src="../images/github.svg" alt="linkedin"></img>
            </a>
            ...
            <a href="../images/SarahWatremet_CV.pdf" target="_blank" rel="noreferrer" alt="link to CV">
                <img src="../images/cv.svg" alt="cv"></img>
            </a>
        </div>
    )
}